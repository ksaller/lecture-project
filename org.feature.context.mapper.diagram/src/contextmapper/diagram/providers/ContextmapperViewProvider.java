 ...
 * @generated
 */
public class ContextmapperViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = ContextmapperVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = ContextmapperVisualIDRegistry.getVisualID(op
					.getSemanticHint());
			if (elementType != null) {
				if (!ContextmapperElementTypes.isKnownElementType(elementType)
				...
				if (!ContextDiagramEditPart.MODEL_ID
						.equals(ContextmapperVisualIDRegistry.getModelID(op
								.getContainerView()))) {
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = ContextmapperVisualIDRegistry
	...
	public Node createRuntimeConfig_2001(EObject domainElement,
		...
		Node label5001 = createLabel(node,
				ContextmapperVisualIDRegistry
						.getType(RuntimeConfigNameEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Edge createExtendConnection_4002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		...
		edge.setType(ContextmapperVisualIDRegistry
				.getType(ExtendConnectionEditPart.VISUAL_ID));
	...
	private void stampShortcut(View containerView, Node target) {
		if (!ContextDiagramEditPart.MODEL_ID
				.equals(ContextmapperVisualIDRegistry.getModelID(containerView))) {
