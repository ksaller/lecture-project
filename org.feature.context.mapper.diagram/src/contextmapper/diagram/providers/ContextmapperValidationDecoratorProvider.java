...
import contextmapper.diagram.part.ValidationMarker;

/**
 * @generated
 */
public class ContextmapperValidationDecoratorProvider extends AbstractProvider
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof ContextmapperDiagramEditor) {
