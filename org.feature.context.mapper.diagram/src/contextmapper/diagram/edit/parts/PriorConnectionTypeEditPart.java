 ...
 * @generated
 */
public class PriorConnectionTypeEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				ContextmapperVisualIDRegistry
						.getType(contextmapper.diagram.edit.parts.PriorConnectionTypeEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public PriorConnectionTypeEditPart(View view) {
		super(view);
	}
