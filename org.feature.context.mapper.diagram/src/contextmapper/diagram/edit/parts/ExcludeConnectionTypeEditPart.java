 ...
 * @generated
 */
public class ExcludeConnectionTypeEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				ContextmapperVisualIDRegistry
						.getType(contextmapper.diagram.edit.parts.ExcludeConnectionTypeEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public ExcludeConnectionTypeEditPart(View view) {
		super(view);
	}
