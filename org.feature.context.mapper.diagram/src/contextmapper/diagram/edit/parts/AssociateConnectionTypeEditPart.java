...
import contextmapper.diagram.edit.policies.ContextmapperTextSelectionEditPolicy;
...
import contextmapper.diagram.providers.ContextmapperParserProvider;

/**
 * @generated
 */
public class AssociateConnectionTypeEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				ContextmapperVisualIDRegistry
						.getType(contextmapper.diagram.edit.parts.AssociateConnectionTypeEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public AssociateConnectionTypeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new ContextmapperTextSelectionEditPolicy());
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new ContextDiagramEditPart.LinkLabelDragPolicy());
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					ContextmapperEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
