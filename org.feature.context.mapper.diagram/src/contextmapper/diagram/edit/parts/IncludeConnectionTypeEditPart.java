 ...
 * @generated
 */
public class IncludeConnectionTypeEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				ContextmapperVisualIDRegistry
						.getType(contextmapper.diagram.edit.parts.IncludeConnectionTypeEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public IncludeConnectionTypeEditPart(View view) {
		super(view);
	}
