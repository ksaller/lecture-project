 ...
 * @generated
 */
public class ContextmapperBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	 ...
	 * @generated
	 */
	protected ContextmapperBaseItemSemanticEditPolicy(IElementType elementType) {
		...
		if (request instanceof ReconnectRequest) {
			...
			if (view instanceof View) {
				Integer id = new Integer(
						ContextmapperVisualIDRegistry.getVisualID((View) view));
	...
	private IElementType getContextElementType(IEditCommandRequest request) {
		IElementType requestContextElementType = ContextmapperElementTypes
	...
	public static LinkConstraints getLinkConstraints() {
		LinkConstraints cached = ContextmapperDiagramEditorPlugin.getInstance()
				.getLinkConstraints();
		if (cached == null) {
			ContextmapperDiagramEditorPlugin.getInstance().setLinkConstraints(
