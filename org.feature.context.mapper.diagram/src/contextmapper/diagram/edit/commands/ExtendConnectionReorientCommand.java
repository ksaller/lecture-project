 ...
 * @generated
 */
public class ExtendConnectionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ExtendConnectionReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof ExtendConnection) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return ContextmapperBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistExtendConnection_4002(container, getLink(),
						getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		Context container = (Context) getLink().eContainer();
		return ContextmapperBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistExtendConnection_4002(container, getLink(), source,
						getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected ExtendConnection getLink() {
		return (ExtendConnection) getElementToEdit();
	}
