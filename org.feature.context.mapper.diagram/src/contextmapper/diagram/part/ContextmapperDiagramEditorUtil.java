 ...
 * @generated
 */
public class ContextmapperDiagramEditorUtil {
	...
	public static Resource openModel(Shell shell, String description,
		...
		try {
			...
			MessageDialog
					.openError(
							shell,
							Messages.ContextmapperDiagramEditorUtil_OpenModelResourceErrorDialogTitle,
							NLS.bind(
									Messages.ContextmapperDiagramEditorUtil_OpenModelResourceErrorDialogMessage,
									fileName));
		}
		return resource;
	}
	...
	public static void runWizard(Shell shell, Wizard wizard, String settingsKey) {
		IDialogSettings pluginDialogSettings = ContextmapperDiagramEditorPlugin
	...
	public static Resource createDiagram(URI diagramURI, URI modelURI,
		...
		progressMonitor
				.beginTask(
						Messages.ContextmapperDiagramEditorUtil_CreateDiagramProgressTask,
						3);
		...
		AbstractTransactionalCommand command = new AbstractTransactionalCommand(
				editingDomain,
				Messages.ContextmapperDiagramEditorUtil_CreateDiagramCommandLabel,
				Collections.EMPTY_LIST) {
			protected CommandResult doExecuteWithResult(
					IProgressMonitor monitor, IAdaptable info)
					throws ExecutionException {
				ContextDiagram model = createInitialModel();
				...
				try {
					modelResource
							.save(contextmapper.diagram.part.ContextmapperDiagramEditorUtil
									.getSaveOptions());
					diagramResource
							.save(contextmapper.diagram.part.ContextmapperDiagramEditorUtil
									.getSaveOptions());
	 ...
	 * @generated
	 */
	private static ContextDiagram createInitialModel() {
		return ContextmapperFactory.eINSTANCE.createContextDiagram();
	}
	 ...
	 * @generated
	 */
	private static void attachModelToResource(ContextDiagram model,
			Resource resource) {
