 ...
 * @generated
 */
public class ContextmapperInitDiagramFileAction implements
	...
	public void run(IAction action) {
		TransactionalEditingDomain editingDomain = GMFEditingDomainFactory.INSTANCE
				.createEditingDomain();
		Resource resource = ContextmapperDiagramEditorUtil.openModel(
		...
		Wizard wizard = new ContextmapperNewDiagramFileWizard(
				resource.getURI(), diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				ContextDiagramEditPart.MODEL_ID));
		ContextmapperDiagramEditorUtil.runWizard(getShell(), wizard,
