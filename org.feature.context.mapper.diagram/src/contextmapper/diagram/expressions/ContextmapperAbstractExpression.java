 ...
 * @generated
 */
public abstract class ContextmapperAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = ContextmapperDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected ContextmapperAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
