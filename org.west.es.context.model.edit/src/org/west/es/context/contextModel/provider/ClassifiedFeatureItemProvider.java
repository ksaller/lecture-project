...
/**
 * This is the item provider adapter for a {@link org.west.es.context.contextModel.ClassifiedFeature} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ClassifiedFeatureItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ClassifiedFeature_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ClassifiedFeature_name_feature", "_UI_ClassifiedFeature_type"),
				 ContextModelPackage.Literals.CLASSIFIED_FEATURE__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ContextModelPackage.Literals.CLASSIFIED_FEATURE__FEATURE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addClassificationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ClassifiedFeature_classification_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ClassifiedFeature_classification_feature", "_UI_ClassifiedFeature_type"),
				 ContextModelPackage.Literals.CLASSIFIED_FEATURE__CLASSIFICATION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((ClassifiedFeature)object).getName();
