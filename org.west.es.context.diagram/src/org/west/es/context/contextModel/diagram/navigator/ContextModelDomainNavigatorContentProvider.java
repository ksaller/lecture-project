 ...
 * @generated
 */
public class ContextModelDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public ContextModelDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof org.west.es.context.contextModel.diagram.navigator.ContextModelDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((org.west.es.context.contextModel.diagram.navigator.ContextModelDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new org.west.es.context.contextModel.diagram.navigator.ContextModelDomainNavigatorItem(
