...
public class MessageFormatParser extends
		org.west.es.context.contextModel.diagram.parsers.AbstractParser {
	...
	public IParserEditStatus isValidEditString(IAdaptable adapter,
		...
		if (values == null) {
			return new ParserEditStatus(
					...
					NLS.bind(
							org.west.es.context.contextModel.diagram.part.Messages.MessageFormatParser_InvalidInputError,
