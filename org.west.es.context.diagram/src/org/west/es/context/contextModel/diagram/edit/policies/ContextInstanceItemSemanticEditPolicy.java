 ...
 * @generated
 */
public class ContextInstanceItemSemanticEditPolicy
		extends
	 ...
	 * @generated
	 */
	public ContextInstanceItemSemanticEditPolicy() {
		super(
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (org.west.es.context.contextModel.diagram.part.ContextModelVisualIDRegistry
					.getVisualID(outgoingLink) == org.west.es.context.contextModel.diagram.edit.parts.ContextInstanceIncludeLinksEditPart.VISUAL_ID) {
