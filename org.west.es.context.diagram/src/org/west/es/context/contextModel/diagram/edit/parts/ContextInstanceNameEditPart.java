 ...
 * @generated
 */
public class ContextInstanceNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ContextInstanceNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new org.west.es.context.contextModel.diagram.edit.policies.ContextModelTextSelectionEditPolicy());
		installEditPolicy(EditPolicy.DIRECT_EDIT_ROLE,
				new LabelDirectEditPolicy());
		installEditPolicy(
				EditPolicy.PRIMARY_DRAG_ROLE,
				new org.west.es.context.contextModel.diagram.edit.parts.ContainerEditPart.NodeLabelDragPolicy());
	}
	...
	protected Image getLabelIcon() {
		...
		return org.west.es.context.contextModel.diagram.providers.ContextModelElementTypes
	...
	public IParser getParser() {
		if (parser == null) {
			parser = org.west.es.context.contextModel.diagram.providers.ContextModelParserProvider
					.getParser(
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(
					this,
					null,
					org.west.es.context.contextModel.diagram.edit.parts.ContextModelEditPartFactory
