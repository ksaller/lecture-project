...
public class DiagramEditorContextMenuProvider extends
	 ...
	 * @generated
	 */
	private org.west.es.context.contextModel.diagram.part.DeleteElementAction deleteAction;
	...
	public DiagramEditorContextMenuProvider(IWorkbenchPart part,
		...
		super(part, viewer);
		this.part = part;
		deleteAction = new org.west.es.context.contextModel.diagram.part.DeleteElementAction(
				part);
		deleteAction.init();
	}
