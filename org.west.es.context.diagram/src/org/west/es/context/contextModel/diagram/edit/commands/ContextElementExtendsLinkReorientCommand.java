 ...
 * @generated
 */
public class ContextElementExtendsLinkReorientCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public ContextElementExtendsLinkReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return org.west.es.context.contextModel.diagram.edit.policies.ContextModelBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistContextElementExtendsLink_4003(
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setExtendsLink(null);
		getNewSource().setExtendsLink(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setExtendsLink(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
