 ...
 * @generated
 */
public class MetamodelInitDiagramFileAction implements
	...
	public void run(IAction action) {
		TransactionalEditingDomain editingDomain = GMFEditingDomainFactory.INSTANCE
				.createEditingDomain();
		Resource resource = MetamodelDiagramEditorUtil.openModel(getShell(),
		...
		Wizard wizard = new MetamodelNewDiagramFileWizard(resource.getURI(),
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				ContextDiagramEditPart.MODEL_ID));
		MetamodelDiagramEditorUtil.runWizard(getShell(), wizard,
