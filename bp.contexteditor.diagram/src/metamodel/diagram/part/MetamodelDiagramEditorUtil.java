 ...
 * @generated
 */
public class MetamodelDiagramEditorUtil {
	...
	public static Resource openModel(Shell shell, String description,
		...
		try {
			...
			MessageDialog
					.openError(
							shell,
							Messages.MetamodelDiagramEditorUtil_OpenModelResourceErrorDialogTitle,
							NLS.bind(
									Messages.MetamodelDiagramEditorUtil_OpenModelResourceErrorDialogMessage,
									fileName));
		}
		return resource;
	}
	...
	public static void runWizard(Shell shell, Wizard wizard, String settingsKey) {
		IDialogSettings pluginDialogSettings = MetamodelDiagramEditorPlugin
	...
	public static Resource createDiagram(URI diagramURI, URI modelURI,
		...
		progressMonitor.beginTask(
				Messages.MetamodelDiagramEditorUtil_CreateDiagramProgressTask,
				3);
		...
		AbstractTransactionalCommand command = new AbstractTransactionalCommand(
			...
			protected CommandResult doExecuteWithResult(
				...
				try {
					modelResource
							.save(metamodel.diagram.part.MetamodelDiagramEditorUtil
									.getSaveOptions());
					diagramResource
							.save(metamodel.diagram.part.MetamodelDiagramEditorUtil
									.getSaveOptions());
	...
	private static ContextDiagram createInitialModel() {
		return MetamodelFactory.eINSTANCE.createContextDiagram();
	}
