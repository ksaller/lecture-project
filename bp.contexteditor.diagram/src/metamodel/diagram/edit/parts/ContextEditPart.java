...
import metamodel.diagram.edit.policies.ContextItemSemanticEditPolicy;
...
public class ContextEditPart extends ShapeNodeEditPart {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(MetamodelVisualIDRegistry
	...
	public List<IElementType> getMATypesForTarget(IElementType relationshipType) {
		...
		} else if (relationshipType == MetamodelElementTypes.IncludeConnection_4002) {
