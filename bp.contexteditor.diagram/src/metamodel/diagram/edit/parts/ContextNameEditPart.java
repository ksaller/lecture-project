...
import metamodel.diagram.edit.policies.MetamodelTextSelectionEditPolicy;
import metamodel.diagram.part.MetamodelVisualIDRegistry;
import metamodel.diagram.providers.MetamodelElementTypes;
import metamodel.diagram.providers.MetamodelParserProvider;
...
public class ContextNameEditPart extends CompartmentEditPart implements
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new MetamodelTextSelectionEditPolicy());
	...
	protected Image getLabelIcon() {
		...
		return MetamodelElementTypes.getImage(parserElement.eClass());
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					MetamodelEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
