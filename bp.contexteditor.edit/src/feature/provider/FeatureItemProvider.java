...
/**
 * This is the item provider adapter for a {@link feature.Feature} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FeatureItemProvider
	extends FeatureTreeNodeItemProvider
	implements
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FeaturePackage.Literals.FEATURE__CONSTRAINTS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FeaturePackage.Literals.FEATURE__ANNOTATIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FeaturePackage.Literals.FEATURE__ANNOTATIONS,
				 FeatureFactory.eINSTANCE.createAnnotation()));
	}
