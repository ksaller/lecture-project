...
public class ContextItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MetamodelPackage.Literals.CONTEXT__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MetamodelPackage.Literals.CONTEXT__CLASSIFIES,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MetamodelPackage.Literals.CONTEXT__TARGET_CONNECTIONS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MetamodelPackage.Literals.CONTEXT__SOURCE_CONNECTIONS,
				 MetamodelFactory.eINSTANCE.createPriorConnection()));

		newChildDescriptors.add
			(createChildParameter
				(MetamodelPackage.Literals.CONTEXT__SOURCE_CONNECTIONS,
				 MetamodelFactory.eINSTANCE.createExcludeConnection()));

		newChildDescriptors.add
			(createChildParameter
				(MetamodelPackage.Literals.CONTEXT__SOURCE_CONNECTIONS,
				 MetamodelFactory.eINSTANCE.createAssociateConnection()));
	}
