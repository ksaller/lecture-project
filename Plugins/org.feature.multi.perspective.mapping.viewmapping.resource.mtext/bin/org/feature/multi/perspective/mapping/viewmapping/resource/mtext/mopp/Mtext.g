			...
			(
				a5_0 = parse_org_feature_multi_perspective_mapping_viewmapping_Mapping				{
					...
					if (a5_0 != null) {
						...
						collectHiddenTokens(element);
						retrieveLayoutInformation(element, org.feature.multi.perspective.mapping.viewmapping.resource.mtext.grammar.MtextGrammarInformationProvider.MTEXT_0_0_0_8_0_0_0, a5_0, true);
