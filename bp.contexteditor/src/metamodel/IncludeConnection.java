...
public interface IncludeConnection extends EObject {
	 ...
	 * @model opposite="includes" resolveProxies="false" required="true"
	 * @generated
	 */
	RuntimeConfig getSource();

	/**
	 * Sets the value of the '{@link metamodel.IncludeConnection#getSource <em>Source</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Sets the value of the '{@link metamodel.IncludeConnection#getTarget <em>Target</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
