...
public class FeaturePackageImpl extends EPackageImpl implements FeaturePackage {
	 ...
	 * @see feature.FeaturePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EAttribute getFeatureTreeNode_MinCardinality() {
		return (EAttribute)featureTreeNodeEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getFeatureTreeNode_MaxCardinality() {
		return (EAttribute)featureTreeNodeEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(featureTreeNodeEClass, FEATURE_TREE_NODE__MIN_CARDINALITY);
		createEAttribute(featureTreeNodeEClass, FEATURE_TREE_NODE__MAX_CARDINALITY);
	...
	public void initializePackageContents() {
		...
		groupEClass.getESuperTypes().add(this.getFeatureTreeNode());
		...
		initEAttribute(getFeatureTreeNode_MinCardinality(), ecorePackage.getEInt(), "minCardinality", null, 1, 1, FeatureTreeNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getFeatureTreeNode_MaxCardinality(), ecorePackage.getEInt(), "maxCardinality", null, 1, 1, FeatureTreeNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
