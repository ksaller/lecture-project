/**
 */
package org.west.es.context.contextModel.util;
...
public class ContextModelAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected ContextModelSwitch<Adapter> modelSwitch =
		new ContextModelSwitch<Adapter>() {
			@Override
			...
			@Override
			public Adapter caseContextInstance(ContextInstance object) {
				return createContextInstanceAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.west.es.context.contextModel.Container <em>Container</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.west.es.context.contextModel.ContextElement <em>Context Element</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.west.es.context.contextModel.ContextInstance <em>Context Instance</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.west.es.context.contextModel.ClassifiedFeature <em>Classified Feature</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
